...
// TODO: Add scrollTo for navbar and buttons, replace A tag with something else
// TODO: Link experience read more to corresponding project
    ...
    return (
        <div className="App">
                ...
                <div className="container">
                    ...
                    <div className="col-2">
                        ...
                        <div className="info">
                            ...
                            <div>
                                <p className="title">Email: <a tabIndex={-1} href={"mailto:"+config.email}>{config.email}</a></p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="footer">
                <div className="container">
                    <p>Licensed under MIT License - <a target="_blank" rel="noreferrer" href="https://github.com/stenterstal/stenterstal.com/blob/master/LICENSE">Read More</a></p>
                </div>
            </div>
        </div>
    );
